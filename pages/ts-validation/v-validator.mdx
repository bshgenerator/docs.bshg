...
| Method                                 | Description                                                                                                                             |
|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| **options(options: ValidatorOptions)** | Updates the validator's configuration options after instantiation. [See options](/docs/library/validation/typescrip/validator-options)  |
